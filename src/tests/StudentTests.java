...
public class StudentTests extends TestCase {
    ...
    public void testGraphMisc() {
        ...
        assertTrue(TestingSupport.correctResults("studentTestGraphMisc.txt", answer));
    }
    ...
    public void testBFS() {
        ...
        graph.doBreadthFirstSearch("A", printCallBack);
        results.append(printCallBack.getResult());

        results.append(TestingSupport.hardCodingPrevention);

        assertTrue(TestingSupport.correctResults("studentTestBFS.txt", results.toString()));
    }
    ...
    public void testDFS() {
        ...
        assertTrue(TestingSupport.correctResults("studentTestDFS.txt", results.toString()));
    }
    ...
    public void testDijkstras() {
        ...
        assertTrue(TestingSupport.correctResults("studentTestDijkstras.txt", answer));
    }
